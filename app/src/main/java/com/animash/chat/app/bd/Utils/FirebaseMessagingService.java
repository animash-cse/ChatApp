package com.animash.chat.app.bd.Utils;
...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        String NOTIFICATION_CHANNEL_ID = "FMS";

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, "FMS Notifications", NotificationManager.IMPORTANCE_HIGH);
