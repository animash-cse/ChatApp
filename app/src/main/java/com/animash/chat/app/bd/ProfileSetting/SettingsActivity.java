package com.animash.chat.app.bd.ProfileSetting;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    private EditText display_name, display_email, user_phone, user_profession, user_nickname, user_gender;
    ...
    private String profile_download_url, profile_thumb_download_url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_gender = findViewById(R.id.userGender);
        ...
        saveInfoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                saveInformation(uName, uNickname, uPhone, uProfession);
            }
        });
